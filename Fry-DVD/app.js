...
var START_URL = "https://www.frys.com/category/Outpost/Video/Blu+Ray+and+DVD+Players/&site=tv_nav:bluray%20dvd%20players";
...
for(var i =1;i<=5;i++){
  k=20*i;
  pagesToVisit.push("https://www.frys.com/search;jsessionid=ezJpSR07NkHyqfYekL7IKw__?site=tv_nav:bluray%20dvd%20players&cat=-68524&nearbyStoreName=false&pType=pDisplay&resultpage="+i+"&start="+k+"&rows=20")
}
function crawl() {
